...
{
  source_path = paste("./data/dataset/dataset/validation/arima/", toString(id), sep="")
...
write.table(counts_frame, "./data/dataset/dataset/validation/arima_prediction.txt", sep="\t") 
