...
{
  source_path = paste("./data/dataset/dataset/shop_classify/check/arima/", toString(id), sep="")
...
write.table(counts_frame, "./data/dataset/dataset/shop_classify/check/arima_prediction.txt",sep="\t")
